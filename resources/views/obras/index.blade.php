                    ...
                    <div class="mb-3">
                        ...
                        <div id="areasContainer">
                            <div class="input-group mb-1 area-row">
                                <input type="text" name="areas[]" class="form-control form-control-sm"
                            ...
                            <div>
                                ...
                                <div class="d-flex flex-wrap gap-1 mt-1">
                                    @foreach($obra->areas as $area)
                                        <span class="badge"
                                            style="background:#1f6feb22;color:#58a6ff;border:1px solid #1f6feb44;font-size:.72rem">
                                            {{ $area->nombre }}
                                        </span>
                                    @endforeach
                                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            ...
                                            @endif
                                            <form method="POST" action="{{ route('trabajadores.destroy', $t->id) }}"
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group">
                        ...
                        <button class="btn btn-outline-secondary btn-sm"
                            onclick="copiarLink(document.getElementById('linkGenerado').value)">
