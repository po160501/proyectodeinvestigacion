...
<style>
    ...
    .tree-item.active { background:#1f6feb18; border-left:3px solid #1f6feb; }
    .tree-area  { font-weight:600; font-size:.88rem; }
    .tree-trab  { font-size:.83rem; padding-left:24px; }
    .tree-children { overflow:hidden; transition:max-height .25s ease; max-height:0; }
    .tree-children.open { max-height:2000px; }
    .chevron { font-size:18px; transition:transform .2s; color:#8b949e; flex-shrink:0; }
    .chevron.open { transform:rotate(90deg); }
    .db-badge { font-size:.72rem; font-weight:700; padding:2px 7px; border-radius:10px; white-space:nowrap; }
    .db-safe   { background:#3fb95022; color:#3fb950; border:1px solid #3fb95055; }
    .db-warn   { background:#f0883e22; color:#f0883e; border:1px solid #f0883e55; }
    .db-danger { background:#f8514922; color:#f85149; border:1px solid #f8514955; }
    .db-none   { background:#30363d44; color:#8b949e; border:1px solid #30363d; }
    .tree-scroll { max-height:480px; overflow-y:auto; }
</style>
@endpush
